// CTD Crash Reporter - Elden Ring UE4SS Mod
...
public:
    CTDCrashReporter() : CppUserModBase()
    {
        ...
        ModDescription = STR("Crash reporter for Elden Ring - sends crash data to ctd.ezmode.games");
    ...
    {
        Output::send<LogLevel::Verbose>(STR("[CTD] Initializing crash reporter for Elden Ring\n"));
        ...
        ctd::init("elden-ring", game_version.c_str(), ue_version.c_str());
